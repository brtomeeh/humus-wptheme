...
function humus_styles() {
	...
	wp_register_style('main', get_template_directory_uri() . '/css/main.css', array('skeleton', 'webfonts', 'responsive-nav'), '0.1.6');
...
function humus_scripts() {
	...
	wp_register_script('frontend', get_template_directory_uri() . '/js/frontend.js', array('jquery', 'underscore', 'imagesloaded', 'fitvids', 'lockfixed', 'sly', 'responsive-nav', 'jquery-mousewheel', 'humus-modernizr'), '0.3.7');
...
function humus_gallery($atts, $content = null) {
	...
	wp_enqueue_script('humus-gallery', get_template_directory_uri() . '/js/gallery.js', array('jquery', 'sly'), '0.1.4');
...
function humus_album_gallery($atts, $content = null) {
	...
	wp_enqueue_script('humus-gallery', get_template_directory_uri() . '/js/gallery.js', array('jquery', 'sly', 'isotope', 'imagesloaded', 'swipebox'), '0.1.4');
...
function humus_add_video_wmode_transparent($html, $url, $attr) {
